<template>
  <div>
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>註冊管理</el-breadcrumb-item>
    </el-breadcrumb>

    <h3 style="margin: 20px 0;">註冊管理</h3>

    <el-table :data="tableData" border style="width: 100%">
      <el-table-column prop="id" label="ID" width="60" align="center"></el-table-column>
      <el-table-column prop="name" label="客戶名" align="center"></el-table-column>
      <el-table-column prop="gender" label="性別" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleDelete(id) {
      ...
      let url = "http://localhost:9080/regs/" + id + "/delete";
      this.axios
    ...
    loadRegs: function () {
      let url = "http://localhost:9080/regs/";
      this.axios
          .create({headers: {'Authorization': localStorage.getItem('jwt')}})
